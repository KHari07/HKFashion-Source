...
<head>
    ...
    <style>
        ...
        .submit-btn { 
            background: #f39c12; color: white; padding: 12px 20px; border: none; 
...
<body>
    ...
    <div class="admin-wrapper">
        <h2 style="margin-top: 0; border-bottom: 2px solid #f39c12; padding-bottom: 10px; color: #f39c12;">Edit Product #${product.productId}</h2>
        ...
        <form action="${pageContext.request.contextPath}/admin/edit-product" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="categoryId" required value="${product.categoryId}">
            </div>
            
            <div class="form-group">
                <label>Base Price (&#8377;)</label>
                <input type="number" step="0.01" name="basePrice" required value="${product.basePrice}">
            </div>
            
            <div class="form-group">
                <label>Image URL</label>
                <input type="text" name="imageUrl" required value="${product.imageUrl}">
            </div>
